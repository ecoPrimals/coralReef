...
*93/93 cross-spring WGSL shaders compile to native SASS. 3512 tests (3506 passing, 6 ignored; post-excision: diesel stack removed).
...
Sprint 14 / Wave 146: quality gates green (fmt, clippy pedantic+nursery zero warnings, doc, all files <1000 LOC, deny.toml enforced).
