...
cargo test --workspace            # 4200+ passing (~155 ignored hardware)
...
- **Test coverage**: 90%+ target (current: ~66% workspace line, measured with `cargo llvm-cov`; see `scripts/coverage.sh`)
