...
cargo test --workspace            # 3062+ passing (+102 ignored hardware)
...
- **Test coverage**: 90%+ target (current: 65.8% line / 79.6% non-hardware, measured with `cargo llvm-cov`; see `scripts/coverage.sh`)
