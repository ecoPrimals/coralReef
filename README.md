...
**Version**: 0.2.0 — Phase 10, Sprint 13 / Wave 53 (Vector math: normalize/length/cross/distance, texture load tld.*, NumLayers query, RT core intersection builtins, surface collection fix; 3220 tests, zero unsafe, zero clippy warnings)  
...
cargo test --workspace     # 3220 passing, 0 failed
...
| `cargo test --workspace` | PASS (3220 passing, 0 failed) |
