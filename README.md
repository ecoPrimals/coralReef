...
**Version**: 0.2.0 — Phase 10, Sprint 13 / Wave 61 (Inverse trig, geometry math, bit ops, texture queries, module refactor; 3234 tests, zero unsafe, zero clippy warnings)  
...
cargo test --workspace     # 3234 passing, 0 failed
...
| `cargo test --workspace` | PASS (3234 passing, 0 failed) |
...
| 10 | Spring absorption, compiler hardening, Compute Trio, deep debt | **Active** — Sprint 13: vector math, tld.*, NumLayers, RT core builtins, depth/array/cube textures, live discovery. 3234 tests, zero debt |
