...
**Status**: Phase 10 — Iteration 101+ (Sprint 10: ImageQuery PTX, 8 new math functions, 3 new builtins, lib_tests split. Prior: subgroup ops, f64 fixes, HMMA GEMM, IPC aliases, texture expansion; pure compiler primal; 3165 tests, zero unsafe, zero debt)  
...
cargo test --workspace     # 3165 passing, 0 failed
...
| `cargo test --workspace` | PASS (3165 passing, 0 failed) |
...
| 10 | Spring absorption, compiler hardening, Compute Trio, deep debt | **Active** — PTX SM120, RDNA2 parity, diesel excision complete. Wire contract frozen. HMMA codegen shipped. 3165 tests, zero debt |
