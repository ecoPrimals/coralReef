...
cargo test --workspace     # 3159 passing, 0 failed
...
| `cargo test --workspace` | PASS (3159 passing, 0 failed) |
...
| 10 | Spring absorption, compiler hardening, Compute Trio, deep debt | **Active** — PTX SM120, RDNA2 parity, diesel excision complete. Wire contract frozen. HMMA codegen shipped. 3159 tests, zero debt |
