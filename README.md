...
**Status**: Phase 10 — Iteration 18 (Deep Debt Solutions)
...
cargo test --workspace     # 1138 passing, 29 ignored
...
| `coral-reef` | Shader compiler — 36/47 cross-spring shaders compiling, f64 lowering, optimizers, RA, vendor encoding |
...
| 10 | Spring absorption, compiler hardening, E2E verified | **Iteration 18** |
