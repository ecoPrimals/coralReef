...
| 10 | Spring absorption, compiler hardening, Compute Trio, deep debt | **Active** — Sprint 13: inverse trig, geometry, bit ops, texture queries, DH-1, module refactor. 3234 tests, zero debt |
