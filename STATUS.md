...
**Version**: 0.2.0 — Sprint 14 / Wave 125 (shader.compile.multi: mixed-input batch compilation (WGSL/SPIR-V/GLSL), JSON-RPC + tarpc wired, 17 batch tests. 3631 tests, 84% line coverage, zero clippy warnings, zero unsafe.)
