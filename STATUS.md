...
**Version**: 0.2.0 — Sprint 14 / Wave 156j (memory ops + binary ops coverage, copy_src_ref removal, C2 dual-socket. 3,580 tests, zero unsafe, zero clippy warnings on Linux + Windows.)
