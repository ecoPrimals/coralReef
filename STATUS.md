...
**Version**: 0.2.0 — Sprint 14 / Wave 67 (Pipeline completeness + hotSpring gap resolution: adapter-aware arch routing (sm_120 inferred from hardware identity), copy prop multi-component SSA fix (subgroupBallot uvec4), f64 pow spec-gap documented. 3245 tests, zero unsafe, zero clippy warnings)
