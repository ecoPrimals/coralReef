...
**Version**: 0.2.0 — Sprint 14 / Wave 156p (G65 protocol negotiation, dispatch refactor, C2 dual-socket. 3,686 tests, zero unsafe, zero clippy warnings on Linux + Windows.)
