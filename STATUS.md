...
**Version**: 0.2.0 — Sprint 14 / Wave 156q (G65 protocol negotiation, C3 health shim verified, C2 dual-socket. 3,689 tests, zero unsafe, zero clippy warnings on Linux + Windows.)
