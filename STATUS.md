...
**Version**: 0.2.0 — Sprint 14 / Wave 124 (Code size compliance: op_shuffle + gpr_hazards extraction, named constants for capability metadata. 3601 tests, 84% line coverage, zero clippy warnings, zero unsafe. Zero hand-written production files >800 LOC.)
