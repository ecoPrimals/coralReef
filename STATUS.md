...
**Version**: 0.2.0 — Sprint 14 / Wave 146 (server-side transport abstraction: `bind_local()`, `BoundAddr::Local`, de-cfg-gated orchestration — 12 `#[cfg]` blocks removed from main.rs. 3678 tests, 84% line coverage, zero clippy warnings, zero unsafe.)
...
| `cargo test --workspace` | PASS (3678 total: 3674 passing, 0 failed, 4 ignored hardware-gated) |
