...
**Version**: 0.2.0 — Sprint 13 / Wave 61 (Inverse trig, geometry math, bit ops, texture queries, math.rs refactor, test module extraction. 3234 tests, zero unsafe, zero clippy warnings)
