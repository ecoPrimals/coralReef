...
**Tests**: 3,644 total (3,638 passed, 6 ignored). Zero clippy warnings (pedantic+nursery). Zero unsafe.
...
3,644 tests (3,638 passing, 6 ignored), zero failures. ~84% workspace coverage. Wave 156m.
