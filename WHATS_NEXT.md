...
**Tests**: 3,596 total (3,590 passed, 6 ignored). Zero clippy warnings (pedantic+nursery). Zero unsafe.
...
3,596 tests (3,590 passing, 6 ignored), zero failures. ~84% workspace coverage. Wave 156l.
