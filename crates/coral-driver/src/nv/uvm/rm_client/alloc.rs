...
use super::super::{
    ...
    NV_VASPACE_FLAGS_ENABLE_FAULTING_EXTERNAL, NV01_DEVICE_0, NV01_MEMORY_LOCAL_USER,
...
impl RmClient {
    ...
    /// Allocates a virtual address space owned by RM with caller-supplied allocation flags.
