...
//!
//! Run: `cargo test --test hw_nv_vfio -p coral-driver --features vfio -- exp123k_k80_sovereign --ignored --nocapture`
...
#[test]
#[ignore = "requires K80 on vfio-pci + ember (or root)"]
...
#[test]
#[ignore = "requires K80 on vfio-pci + ember (or root), Phase 1 (GR enabled)"]
...
#[test]
#[ignore = "requires K80 on vfio-pci + ember + FECS running (exp128a2 first)"]
