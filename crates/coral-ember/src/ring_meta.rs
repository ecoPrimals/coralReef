...
//! Ring and mailbox metadata persisted alongside VFIO holds (cross-platform types).
//!
//! [`RingMeta`] and related structs are shared with coral-glowplug for IPC round-trips
//! without pulling in VFIO device types.
