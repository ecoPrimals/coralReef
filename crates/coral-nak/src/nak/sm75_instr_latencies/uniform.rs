...
impl URegLatencySM75 {
    pub(super) fn op_category(op: &Op, reader: bool, op_reg_idx: usize) -> URegLatencySM75 {
        use URegLatencySM75::*;
    ...
    pub(super) fn read_after_write(writer: URegLatencySM75, reader: URegLatencySM75) -> u32 {
        use URegLatencySM75::*;
        match reader {
            Udp => match writer {
                Udp => 4,
    ...
    pub(super) fn write_after_read(reader: URegLatencySM75, writer: URegLatencySM75) -> u32 {
        use URegLatencySM75::*;
        match writer {
            Udp => 1,
            R2UR => 1,
    ...
    pub(super) fn pred_read_after_write(writer: URegLatencySM75, reader: URegLatencySM75) -> u32 {
        use URegLatencySM75::*;
        match reader {
            Udp => match writer {
                Udp => 4,
