...
impl RegLatencySM80 {
    ...
    fn write_after_write(writer1: RegLatencySM80, writer2: RegLatencySM80, has_pred: bool) -> u32 {
        use RegLatencySM80::*;
        match writer2 {
...
impl PredLatencySM80 {
    ...
    fn pred_read_after_write(writer: PredLatencySM80, reader: PredLatencySM80) -> u32 {
        match reader {
    ...
    fn pred_write_after_read(_reader: PredLatencySM80, _writer: PredLatencySM80) -> u32 {
        1
    }
}
...
impl URegLatencySM80 {
    ...
    fn read_after_write(writer: URegLatencySM80, reader: URegLatencySM80) -> u32 {
        use URegLatencySM80::*;
        match reader {
    ...
    fn write_after_read(reader: URegLatencySM80, writer: URegLatencySM80) -> u32 {
        use URegLatencySM80::*;
        match writer {
...
impl UPredLatencySM80 {
    ...
    fn pred_read_after_write(writer: UPredLatencySM80, reader: UPredLatencySM80) -> u32 {
        use UPredLatencySM80::*;
        match reader {
            Coupled => match writer {
                Udp => 6,
    ...
    fn pred_write_after_write(writer1: UPredLatencySM80, writer2: UPredLatencySM80) -> u32 {
        use UPredLatencySM80::*;
        match writer2 {
            Udp => match writer1 {
                Udp => 1,
    ...
    fn pred_write_after_read(reader: UPredLatencySM80, writer: UPredLatencySM80) -> u32 {
        use UPredLatencySM80::*;
        match writer {
            Udp => match reader {
    ...
    pub fn raw(write: &Op, dst_idx: usize, read: Option<&Op>, src_idx: usize) -> u32 {
        ...
        match dst_file {
            ...
            RegFile::Pred => {
                ...
                PredLatencySM80::pred_read_after_write(write_latency, read_latency)
            }
            RegFile::UPred => {
                ...
                UPredLatencySM80::pred_read_after_write(write_latency, read_latency)
            }
    ...
    pub fn war(read: &Op, src_idx: usize, write: &Op, dst_idx: usize) -> u32 {
        ...
        match dst_file {
            ...
            RegFile::Pred => {
                ...
                PredLatencySM80::pred_write_after_read(read_latency, write_latency)
            }
            RegFile::UPred => {
                let write_latency = UPredLatencySM80::op_category(write);
                let read_latency = UPredLatencySM80::op_category(read);

                UPredLatencySM80::pred_write_after_read(read_latency, write_latency)
            }
            _ => panic!("Not a register"),
        }
    }
    ...
    pub fn waw(a: &Op, a_dst_idx: usize, b: &Op, b_dst_idx: usize, a_op_pred: bool) -> u32 {
        ...
        match dst_file {
            RegFile::GPR => {
                ...
                RegLatencySM80::write_after_write(write1_latency, write2_latency, a_op_pred)
            }
            RegFile::UGPR => {
                ...
                URegLatencySM80::write_after_write(write1_latency, write2_latency, a_op_pred)
            }
            RegFile::Pred => {
                let write1_latency = PredLatencySM80::op_category(a);
                let write2_latency = PredLatencySM80::op_category(b);

                PredLatencySM80::pred_write_after_write(write1_latency, write2_latency, a_op_pred)
            }
            RegFile::UPred => {
                let write1_latency = UPredLatencySM80::op_category(a);
                let write2_latency = UPredLatencySM80::op_category(b);

                UPredLatencySM80::pred_write_after_write(write1_latency, write2_latency)
            }
            _ => panic!("Not a register"),
        }
    }
