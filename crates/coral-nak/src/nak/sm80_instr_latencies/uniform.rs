...
impl URegLatencySM80 {
    pub(super) fn op_category(op: &Op, reader: bool, op_reg_idx: usize) -> URegLatencySM80 {
        use URegLatencySM80::*;
    ...
    pub(super) fn read_after_write(writer: URegLatencySM80, reader: URegLatencySM80) -> u32 {
        use URegLatencySM80::*;
        match reader {
    ...
    pub(super) fn write_after_read(reader: URegLatencySM80, writer: URegLatencySM80) -> u32 {
        use URegLatencySM80::*;
        match writer {
...
impl UPredLatencySM80 {
    pub(super) fn op_category(op: &Op) -> UPredLatencySM80 {
