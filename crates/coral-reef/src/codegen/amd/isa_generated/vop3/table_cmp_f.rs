...
//!
//! Float comparison ops: V_CMP_F32, V_CMP_F64, V_CMP_F16, V_CMPX_F*, V_CMP_CLASS_F*
//!
...
pub const TABLE: &[InstrEntry] = &[
    ...
    // V_CMP_CLASS_F* (opcodes 136, 143, 152, 159, 168, 184)
    InstrEntry {
