            ...
            IMadSpMode::Explicit([src0, src1, src2]) => {
                ...
                e.set_field(
                    ...
                    match src1.unsigned() {
                        ...
                        U16Lo => 0,
                        _ => crate::codegen::ice!(
                            "SM20 legalization rejects IMadSp src1 non-U16Lo/U24"
                        ),
                    },
                );
                ...
                e.set_field(
                    ...
                    match src0.unsigned() {
                        ...
                        U16Hi => 3,
                        _ => crate::codegen::ice!(
                            "IMadSp src0 unsigned() is always U32/U24/U16Lo/U16Hi"
                        ),
                    },
                );
                e.set_field(
                    ...
                    match src2.unsigned() {
                        ...
                        U16Lo => 2,
                        U16Hi => {
                            crate::codegen::ice!("SM20 legalization rejects IMadSp src2 U16Hi")
                        }
                        _ => crate::codegen::ice!(
                            "IMadSp src2 unsigned() has no other variants here"
                        ),
                    },
                );
            }
