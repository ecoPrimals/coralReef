...
//! NAK compilation pipeline: optimization passes, legalization, RA, encoding.

use super::ir::{Shader, ShaderModel};
use super::sph::{self, CURRENT_MAX_SHADER_HEADER_SIZE};
...
/// Run the full NAK optimization and encoding pipeline on a shader.
