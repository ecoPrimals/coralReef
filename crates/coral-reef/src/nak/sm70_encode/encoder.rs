...
pub(super) fn src_mod_has_abs(src_mod: SrcMod) -> bool {
    match src_mod {
...
pub(super) fn src_mod_has_neg(src_mod: SrcMod) -> bool {
    match src_mod {
...
pub(super) fn src_mod_is_bnot(src_mod: SrcMod) -> bool {
    match src_mod {
        SrcMod::None => false,
        SrcMod::BNot => true,
...
impl ALUSrc {
    pub(super) fn from_src(e: &SM70Encoder<'_>, src: Option<&Src>, op_is_uniform: bool) -> ALUSrc {
