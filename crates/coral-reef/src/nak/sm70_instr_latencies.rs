// Copyright © 2026 BarraCUDA / ecoPrimals contributors
...
// SM70 (Volta GV100 / GV102) instruction latency tables for NAK.
//
...
impl RegLatencySM70 {
    fn op_category(op: &Op, reader: bool, op_reg_idx: usize) -> RegLatencySM70 {
        use RegLatencySM70::*;
        match op {
    ...
    pub fn read_after_write(writer: RegLatencySM70, reader: RegLatencySM70) -> u32 {
        use RegLatencySM70::*;
        match writer {
    ...
    // ── Write-After-Write ─────────────────────────────────────────────────────
    fn write_after_write(writer1: RegLatencySM70, writer2: RegLatencySM70, has_pred: bool) -> u32 {
        use RegLatencySM70::*;
        match writer1 {
            IMADWideAB | DecoupledOther => {
    ...
    // ── Write-After-Read ──────────────────────────────────────────────────────
    fn write_after_read(reader: RegLatencySM70, writer: RegLatencySM70) -> u32 {
        use RegLatencySM70::*;
        match writer {
            CoupledDisp64 | CoupledDisp | CoupledAlu | CoupledFMA | IMADLo | IMADWideLower
            | IMADWideUpper => 1,
    ...
    fn pred_read_after_write(writer: RegLatencySM70, reader: RegLatencySM70) -> u32 {
        use RegLatencySM70::*;
        match reader {
    ...
    fn pred_write_after_write(
        writer1: RegLatencySM70,
        writer2: RegLatencySM70,
        has_pred: bool,
    ) -> u32 {
        use RegLatencySM70::*;
        match writer2 {
    ...
    fn pred_write_after_read(reader: RegLatencySM70, writer: RegLatencySM70) -> u32 {
        use RegLatencySM70::*;
        match writer {
            CoupledDisp | CoupledAlu | CoupledFMA | IMADLo | IMADWideUpper | IMADWideLower => 1,
            RedirectedFP64 => match reader {
