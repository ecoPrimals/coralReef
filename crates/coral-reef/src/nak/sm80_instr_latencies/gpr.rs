...
impl RegLatencySM80 {
    pub(super) fn op_category(op: &Op, reader: bool, op_reg_idx: usize) -> RegLatencySM80 {
        use RegLatencySM80::*;
        match op {
    ...
    pub(super) fn read_after_write(writer: RegLatencySM80, reader: RegLatencySM80) -> u32 {
        use RegLatencySM80::*;
        match reader {
    ...
    pub(super) fn write_after_read(reader: RegLatencySM80, writer: RegLatencySM80) -> u32 {
        use RegLatencySM80::*;
        match writer {
