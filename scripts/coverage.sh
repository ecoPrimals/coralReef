...
for crate in coralreef-core coral-reef coral-reef-stubs coral-reef-bitview coral-reef-isa coral-driver coral-gpu nak-ir-proc primal-rpc-client amd-isa-gen; do
    echo "--- $crate ---"
