...
coralReef is a sovereign Rust NVIDIA shader compiler. It compiles WGSL and
...
| `coral-reef` | Shader compiler: frontend, f64 lowering, optimizers, RA, encoding |
| `coral-reef-isa` | NVIDIA ISA tables, instruction latencies (SM30–SM120), SPH encoding |
...
NVIDIA's MUFU instructions only support f32. coralReef adds software lowering
