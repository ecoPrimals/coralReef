...
description = "Sovereign Rust GPU shader compiler — 3700 tests, WGSL/SPIR-V/GLSL to native GPU binary (NVIDIA SM35-SM120, AMD RDNA2-4), BTSP client handshake (ClientHello standard evolution), provenance signing via BTSP, local_transport client+server, zero unsafe, zero C deps"
date = 2026-07-26
...
- **3700 tests** (3696 passing, 4 ignored — hardware-gated)
- **Version**: 0.2.0 — Sprint 14 / Wave 151b
