...
description = "Sovereign Rust GPU shader compiler — 3209 tests, WGSL/SPIR-V/GLSL to native GPU binary (NVIDIA SM35-SM120, AMD RDNA2-4), tensor-core GEMM, RayQuery PTX, Neural API primal.announce, zero unsafe, zero C deps"
date = 2026-05-26
...
- **3209 tests** passing, 0 failed, 0 ignored
