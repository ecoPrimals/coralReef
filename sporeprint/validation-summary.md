...
description = "Sovereign Rust GPU shader compiler — 3669 tests, WGSL/SPIR-V/GLSL to native GPU binary (NVIDIA SM35-SM120, AMD RDNA2-4), deep debt deduplication, BTSP client handshake, local_transport client+server, zero unsafe, zero C deps"
date = 2026-07-26
...
- **3669 tests** (3665 passing, 4 ignored — hardware-gated)
- **Version**: 0.2.0 — Sprint 14 / Wave 155i, 3,527 tests
